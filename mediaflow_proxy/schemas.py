...
class ExtractorURLParams(GenericParams):
    host: Literal[
        "Doodstream", "FileLions", "FileMoon", "Mixdrop", "Uqload", "Streamtape", "Supervideo", "VixCloud", "Okru", "Maxstream", "LiveTV", "LuluStream", "DLHD", "Fastream", "VidGuard", "Vidmoly", "Vidoza", "Vidoza", "Voe", "Sportsonline", "TurboVidPlay","StreamWish"
